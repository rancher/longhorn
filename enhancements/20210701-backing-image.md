...
1. Launch a new page to present and operate BackingImages.
    ...
    4. Show more info for each BackingImage after clicking button `Detail`:
        ...
        - Use a table to present the file status for each disk based on fields `diskFileStatusMap`:
            ...
            - Users can choose the entries of this disk tables as the input `disks` of API `CleanupDiskImages`. This API is dadicated for manually cleaning up the images in some disks in advance.
